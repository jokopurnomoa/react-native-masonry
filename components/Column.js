...
export default class Column extends Component {
    static propTypes = {
        ...
        touchContainerStyle: PropTypes.object,
    ...
    _renderBrick = (data) => {
        ...
        const { imageContainerStyle, touchContainerStyle, customImageComponent, customImageProps } = this.props;
        const props = { ...brick, gutter, key, imageContainerStyle, touchContainerStyle, customImageComponent, customImageProps };
